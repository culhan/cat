...
class Home_images extends Admin_Controller {
	...
	public function edit($id)
	{
		...
		$data = $this->ion_auth->getData( $id, $this->key_control )->row();
			...
			if ( $this->input->method() == 'post' )
			{
				...
				$this->ion_auth->updateData( ['status' => $dataUpdate['status'] ], ['status' => '0' ], $this->key_control );
				...
				redirect('admin/'.$this->key_control.'/edit/'.$id, 'refresh');
			}
